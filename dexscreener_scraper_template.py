                ...
                while True:
                    ...
                    if _type == "pairs":
                        ...
                        for pair in pairs:
                            ...
                            print("------- TOKEN NAME AND PRICE USD -------")
                            print(
                                token_name,
                                token_price_usd,
                                "created since",
                        ...
                        file_created_at = int(time.time())  # seconds from epoch
                        # WINDOWS FILE SYSTEM
                        filename = f"Data\\dexscreener_{file_created_at}-dex-{dex}-page-{page_number}-interval-{time_interval}.csv"
...
if __name__ == "__main__":
    ...
    asyncio.run(
        dexscreener_scraper(time_intervals.m5, dex=dex_filter.all, save_file=False)
    )
